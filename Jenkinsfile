pipeline {
	...
	stages {
				        ...
				        steps {
                                ...
                                stage('Publish') {
                                        ...
                                        steps {
                                                ...
                                                nexusArtifactUploader artifacts: [[artifactId: 'spring-petclinic', classifier: '', file: 'target/petclinic.war', type: 'war']], credentialsId: 'nexuscred', groupId: 'org.springframework.samples', nexusUrl: '192.168.52.169:8081/nexus', nexusVersion: 'nexus2', protocol: 'http', repository: 'snapshots', version: '4.2.6-SNAPSHOT'
           ...
           steps {
               sh '''
                   scp target/petclinic.war root@192.168.52.110:/opt/tomcat/webapps/petclinic.war;
